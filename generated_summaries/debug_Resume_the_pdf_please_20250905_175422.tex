...
\fancyhead[C]{\sffamily\small Focus: Resume the pdf please}
\fancyhead[R]{\sffamily\small Source: BayesTheorem.pdf}
\fancyfoot[L]{\sffamily\small Generated: 2025-09-05 17:54:22}
\fancyfoot[C]{}
...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vspace{0.8em}
    {\sffamily\Large\color{secondary} Focus Area: Resume the pdf please \par}
    \vspace{1.5em}
    \begin{tcolorbox}[enhanced,width=0.75\textwidth,colback=lightgray,colframe=primary,boxrule=0.8pt,sharp corners,left=6pt,right=6pt,top=6pt,bottom=6pt]\vspace{0.5em}
      ...
      \begin{tabular}{@{}p{0.28\textwidth} p{0.62\textwidth}@{}}
        ...
        \textbf{Generated:} & 2025-09-05 17:54:22 \\
